...
<template>
  <div class="min-h-screen bg-gray-100 flex items-center justify-center p-4">
    <form @submit.prevent="onSubmit" class="w-full max-w-lg bg-white rounded-lg shadow-md p-6 space-y-4">
      ...
      <div class="flex flex-col">
        ...
        <input id="cep" type="text" v-model="form.cep" @blur="lookupCep"
      ...
      <div class="flex flex-col">
        ...
        <input id="estado" type="text" v-model="form.estado" readonly
      ...
      <div class="flex flex-col">
        ...
        <input id="cidade" type="text" v-model="form.cidade" readonly
          class="border border-gray-300 rounded px-3 py-2 bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      <div class="flex flex-col">
        ...
        <input id="bairro" type="text" v-model="form.bairro" readonly
          class="border border-gray-300 rounded px-3 py-2 bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      <div class="flex flex-col">
        ...
        <input id="endereco" type="text" v-model="form.endereco" readonly
          class="border border-gray-300 rounded px-3 py-2 bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      <div class="flex flex-col">
        ...
        <input id="numero" type="text" v-model="form.numero"
          class="border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      <div class="flex flex-col">
        ...
        <input id="nome_contato" type="text" v-model="form.nome_contato"
          class="border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      <div class="flex flex-col">
        ...
        <input id="email_contato" type="email" v-model="form.email_contato"
          class="border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      <div class="flex flex-col">
        ...
        <input id="telefone_contato" type="text" v-model="form.telefone_contato"
          class="border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
...
async function onSubmit() {
  try {
    // Envia POST para /api/contacts (usa base URL relativa)
    const response = await axios.post('/api/contacts', { ...form })

    // Exibe alerta de sucesso personalizado
    ...
    // (Opcional) Redirecionar para outra rota ou atualizar estado...
    console.log('Contato criado:', response.data)
  } catch (error) {
    // Se a API retornar erro de validação (422), o Axios envia em error.response.data.errors
    if (error.response && error.response.status === 422) {
      // Capturar mensagens de validação e exibir ao usuário (por simplicidade, usamos alert)
      const errors = error.response.data.errors
      const firstErrorField = Object.keys(errors)[0]
      const firstErrorMessage = errors[firstErrorField][0]
      alert(firstErrorMessage)
    } else {
      console.error('Erro desconhecido ao criar contato:', error)
      alert('Houve um erro ao salvar o contato.')
    }
  }
}
